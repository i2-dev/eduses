...
__export(src_exports, {
  ...
  Cache: () => Cache,
  DEFAULTS: () => DEFAULTS,
  DualFisheyeAdapter: () => DualFisheyeAdapter,
  ...
  if (adapter) {
    for (const [, p] of [["_", adapter], ...Object.entries(adapter)]) {
      if (p.prototype instanceof AbstractAdapter) {
        checkVersion(p.id, p.VERSION, "5.8.2");
        return p;
      }
    }
  }
...
EquirectangularAdapter.VERSION = "5.8.2";
...
DualFisheyeAdapter.VERSION = "5.8.2";
