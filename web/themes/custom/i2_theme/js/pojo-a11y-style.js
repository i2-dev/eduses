...
// var PojoAllyOptions = {
//     save_expiration: 432e5 // 5 days in milliseconds
// };
!(function () {
    ...
    (function (n, t, o, e) {
        ...
        var i = {
            ...
            settings: {
                ...
                // 添加預設值
                expires: (window.PojoA11yOptions && PojoA11yOptions.save_expiration)
            ...
            buildElements: function () {
                // 将工具栏和跳过内容插入到指定位置
                this.cache.$document.find('#your-target-element').prepend(this.cache.$toolbar);
                this.cache.$document.find('#your-target-element').prepend(this.cache.$skipToContent);
            },
            bindEvents: function () {
                var e = this;
